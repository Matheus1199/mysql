...
--
-- Table structure for table `gafanhoto_assite_curso`
--

DROP TABLE IF EXISTS `gafanhoto_assite_curso`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `gafanhoto_assite_curso`
--

LOCK TABLES `gafanhoto_assite_curso` WRITE;
/*!40000 ALTER TABLE `gafanhoto_assite_curso` DISABLE KEYS */;
INSERT INTO `gafanhoto_assite_curso` VALUES (1,'2014-03-01',1,2),(2,'2015-12-22',3,6),(3,'2014-01-01',22,12),(4,'2016-05-02',30,8);
/*!40000 ALTER TABLE `gafanhoto_assite_curso` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-08-03 12:10:39
